                  ...
                  <div class="col-xl-3">
                    <div class="card" style="background-color: #0a0a0a; color: #fff">
                      <div class="card-body">
                        ...
                        <br><br>
                        <a href="class.php" class="text-white text-decoration-none"
                  ...
                  <div class="col-xl-3">
                    <div class="card" style="background-color: #0a0a0a; color: #fff">
                      <div class="card-body">
                        ...
                        <br><br>
                        <a href="student.php" class="text-white text-decoration-none"
                          style="min-width: 100%; text-align: center;">
                          Xem Thêm
                          <i class="bi bi-arrow-right-circle-fill mx-1"></i>
                        </a>
                  ...
                  <div class="col-xl-3">
                    <div class="card" style="background-color: #0a0a0a; color: #fff">
                      <div class="card-body">
                        ...
                        <br><br>
                        <a href="fee.php" class="text-white text-decoration-none"
                          style="min-width: 100%; text-align: center;">
                          Xem Thêm
                          <i class="bi bi-arrow-right-circle-fill mx-1"></i>
                        </a>
